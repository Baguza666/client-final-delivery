...
import PurchaseOrderBuilder from '@/components/purchase-orders/PurchaseOrderBuilder'
    ...
    return (
        <main className="px-4 sm:px-6 lg:px-8 py-6 md:py-8">
            <header className="mb-8 max-w-5xl mx-auto">
                ...
                <h1 className="text-2xl md:text-3xl font-[800] tracking-tight text-white">Nouveau Bon de Commande</h1>
            </header>
            <PurchaseOrderBuilder clients={clients || []} products={products || []} />
        </main>
    )
}
