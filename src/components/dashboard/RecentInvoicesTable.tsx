                                    ...
                                    <tr key={inv.id} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="py-2 pr-3">
                                            <Link href={`/invoices/${inv.id}`}
                                                className="font-mono text-xs text-zinc-500 group-hover:text-primary transition-colors">
                                                {inv.invoice_number || 'BROUILLON'}
                                            </Link>
                                        </td>
                                        <td className="py-2 pr-3 max-w-[120px]">
                                            <span className="font-medium text-zinc-300 text-xs truncate block">
                                                {inv.client?.name || '—'}
                                            </span>
                                        </td>
                                        ...
                                        <td className="py-2 text-right">
                                            <span className={`inline-flex items-center px-2 py-0.5 rounded-md text-[9px] font-bold border ${badgeClass}`}>
                                                {badgeLabel}
                                            </span>
                                        </td>
                                    </tr>
