...
// ✅ CHUNKING ENGINE
const ITEMS_PER_PAGE = 8; // BL tables are shorter, we can fit more
                            ...
                            <div className="p-[10mm] pb-8 flex-1 flex flex-col relative z-10">
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="w-1/2 text-right">
                                        <h1 className="text-4xl font-[800] tracking-tighter text-zinc-900 uppercase">Bon de<br />Livraison</h1>
